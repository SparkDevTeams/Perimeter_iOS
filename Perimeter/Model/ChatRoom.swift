...
class ChatRoom: Codable{
    ...
    var userProfileIds: [String: Bool]?
    ...
    init(id: String, users: [String: Bool], beaconIdMajor: String, beaconIdMinor: String, location: String, description: String, messages: [Message], currentMessagesId: String, messagesIds: [String]) {
        self.id = "1"
        self.userProfileIds = users
